...
$(function () {
  ...
  window.addEventListener("load", () => {
    // main-visual と main-top の両方を持つ要素を取得
    const mainVisual = document.querySelector(".main-visual.main-top");
    ...
    // さらに0.3秒後
    setTimeout(() => {
      titles.classList.add("is-active");
    }, 1500);
    // 0.5秒後
    setTimeout(() => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const fv = document.querySelector(".main-visual") || document.querySelector(".contact__side") || document.querySelector(".about__side") || document.querySelector(".service__side");
